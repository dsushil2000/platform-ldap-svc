...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("PricingPlatformLdapSvc");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("PricingPlatformLdapSvc");
        ...
        config.getMapConfigs().put("com.walmart.pricing.domain.*", initializeDomainMapConfig(jHipsterProperties));
